/**
 * Golden Barbers – Premium Seasonal Theme Effects v31
 *
 * Clean rewrite: premium quality, subtle execution.
 * Colour palette + atmospheric decorations + connotation elements + banner.
 * Campaign Composition System: multi-element hero overlay compositions.
 *
...
(function () {
    ...
    /* ═══════════════════════════════════════════
       OVERLAY ASSETS – Campaign Composition System
       Defines all overlay images with positioning,
       sizing, rotation, opacity for hero compositions.
    ═══════════════════════════════════════════ */
    var OVERLAY_ASSETS = {
        // Christmas overlays
        christmasOrnaments: {
            img: '../pngtree-christmas-3d-decorations-ball-png-image_2530331.png',
            size: { w: 180, h: 180 },
            pos: { top: '5%', right: '8%' },
            rotation: 10,
            opacity: 0.7
        ...
        christmasBranch: {
            img: '../christmas-vector-decorated-pine-branch-corner-png-704081695030704gdvivfqwvp.png',
            size: { w: 200, h: 200 },
            pos: { top: '0', right: '0' },
            rotation: 0,
            opacity: 0.6
        ...
        // Valentine's overlays
        valentineComposition: {
            img: '../Happy-Valentines-Day-PNG-Clipart.png',
            size: { w: 200, h: 200 },
            pos: { top: '5%', right: '5%' },
            rotation: 5,
            opacity: 0.7
        ...
        valentineCupid: {
            img: '../415-4154675_cupid-silhouette-vector-graphics-image-clip-art-clipart.png',
            size: { w: 150, h: 150 },
            pos: { top: '10%', left: '8%' },
            rotation: -10,
            opacity: 0.65
        ...
        // Easter overlays
        floralBorder: {
            img: '../476-4764181_download-floral-border-clip-art-flower-corner-design-png.png',
            size: { w: 180, h: 180 },
            pos: { top: '0', right: '0' },
            rotation: 0,
            opacity: 0.5
        ...
        rabbitEars: {
            img: '../png-clipart-rabbit-ears-rabbit-ear-thumbnail.png',
            size: { w: 140, h: 140 },
            pos: { top: '5%', left: '5%' },
            rotation: -10,
            opacity: 0.7
        ...
        // Summer overlays
        surfboard: {
            img: '../Surfboard-SVG-Surfing-Clip-Art-Graphics-79916992-1.png',
            size: { w: 150, h: 150 },
            pos: { bottom: '10%', right: '10%' },
            rotation: 20,
            opacity: 0.7
        ...
        // Winter overlays
        snowCorner: {
            img: '../pngtree-snow-corner-background-transparent-silhouette-flake-christmas-vector-png-image_27154152.png',
            size: { w: 200, h: 200 },
            pos: { top: '0', right: '0' },
            rotation: 0,
            opacity: 0.6
        ...
        snowflakeBlack: {
            img: '../Snowflake-black-version-580x386.png',
            size: { w: 120, h: 120 },
            pos: { top: '20%', left: '10%' },
            rotation: 0,
            opacity: 0.5
        ...
        snowHill: {
            img: '../isolated-snow-hill-on-transparent-background-png.png',
            size: { w: 300, h: 150 },
        ...
        // Ramadan/Eid overlays
        lanterns: {
            img: '../Set-of-arabic-lantern-ramadan-silhouette-Graphics-80398453-1.png',
            size: { w: 160, h: 160 },
            pos: { top: '10%', right: '10%' },
            rotation: 0,
            opacity: 0.7
        ...
        islamicFrame: {
            img: '../pngtree-islamic-corner-frame-png-image_7096173.png',
            size: { w: 180, h: 180 },
            pos: { top: '0', right: '0' },
            rotation: 0,
            opacity: 0.6
        ...
        // Black Friday overlays
        blackFridayDesign: {
            img: '../pngtree-black-friday-sale-red-black-png-image_5538745.png',
            size: { w: 200, h: 200 },
            pos: { top: '10%', right: '10%' },
            rotation: 5,
            opacity: 0.8
        ...
        // Flash Sale overlays
        flashSaleDesign: {
            img: '../pngtree-text-box-design-with-flash-sale-writing-clock-and-lightning-icons-vector-png-image_12500328.png',
            size: { w: 220, h: 220 },
            pos: { top: '5%', right: '5%' },
            rotation: 0,
            opacity: 0.75
    ...
    /* ═══════════════════════════════════════════
       CAMPAIGNS – Multi-element Hero Compositions
       Each theme defines which overlays to layer
       in the hero section for rich visual impact.
    ═══════════════════════════════════════════ */
    var CAMPAIGNS = {
        christmas: {
            enabled: true,
            elements: ['christmasBranch', 'santaHat', 'ornamentSingle', 'holly', 'mistletoe']
        },
        valentines: {
            enabled: true,
            elements: ['valentineComposition', 'heartIcon', 'heartArrow', 'rose', 'loveLetter']
        },
        easter: {
            enabled: true,
            elements: ['floralBorder', 'bunny', 'easterEgg', 'cherryBlossom', 'basket']
        },
        halloween: {
            enabled: true,
            elements: ['witchHat', 'pumpkin', 'batSwarm', 'bat']
        },
        summer: {
            enabled: true,
            elements: ['sunIcon', 'palmTree', 'sunglasses', 'surfboard', 'coffee']
        },
        autumn: {
            enabled: true,
            elements: ['autumnBranch', 'chestnut', 'mushroom']
        },
        winter: {
            enabled: true,
            elements: ['snowCorner', 'snowHill', 'snowflakeBlack', 'snowflake2', 'scarf']
        },
        ramadan: {
            enabled: true,
            elements: ['islamicFrame', 'crescentMoon', 'lanternSingle', 'lanternTw', 'star']
        },
        eid: {
            enabled: true,
            elements: ['islamicFrame', 'crescentStar', 'mosque', 'lanterns', 'star']
        },
        blackfriday: {
            enabled: true,
            elements: ['blackFridayDesign', 'tagIcon', 'shoppingBag', 'megaphone']
        },
        flashsale: {
            enabled: true,
            elements: ['flashSaleDesign', 'lightning', 'stopwatch']
        },
        newyear: {
            enabled: true,
            elements: ['fireworks', 'champagne', 'clockIcon', 'confetti']
        }
    };
    ...
    /* ═══════════════════════════════════════════
       DEPRECATED - OLD CONNOTATIONS SYSTEM
       Replaced by seasonal-overlays-engine.js v2.0
       Keeping for reference only - NOT USED
    ═══════════════════════════════════════════ */
    /* DEPRECATED */ var CONNOTATIONS = {
        christmas: [
    ...
    function applyCSS(accent, colors) {
        ...
        state.themeStyleEl.textContent = [
            ...
            '[data-gb-theme] .hero-content{z-index:10}',
            '[data-gb-theme] .hero-showcase{z-index:2}',
    ...
    /* DEPRECATED - Replaced by GBSeasonalOverlays.apply() */
    ...
    /* DEPRECATED - Replaced by GBSeasonalOverlays.cleanup() */
    ...
    /* ═══════════════════════════════════════════
       DEPRECATED - OLD HERO OVERLAY SYSTEM
       Replaced by seasonal-overlays-engine.js v2.0
       Keeping for reference only - NOT USED
    ═══════════════════════════════════════════ */
    /* DEPRECATED */ function renderHeroOverlays(themeId) {
        var campaign = CAMPAIGNS[themeId];
        if (!campaign || !campaign.enabled || !campaign.elements) return;
        ...
        campaign.elements.forEach(function(overlayKey) {
            var overlay = OVERLAY_ASSETS[overlayKey];
            if (!overlay) return;

            var el = document.createElement('div');
            el.className = 'gb-hero-overlay';
            el.style.cssText = 'position:absolute;pointer-events:none;z-index:1;'
                + 'width:' + (overlay.size.w || 100) + 'px;'
                + 'height:' + (overlay.size.h || 100) + 'px;'
                + (overlay.pos.top ? 'top:' + overlay.pos.top + ';' : '')
                + (overlay.pos.bottom ? 'bottom:' + overlay.pos.bottom + ';' : '')
                + (overlay.pos.left ? 'left:' + overlay.pos.left + ';' : '')
                + (overlay.pos.right ? 'right:' + overlay.pos.right + ';' : '')
                + (overlay.rotation ? 'transform:rotate(' + overlay.rotation + 'deg);' : '')
                + 'opacity:' + (overlay.opacity || 0.7);

            var img = document.createElement('img');
            img.src = (overlay.img.indexOf('/') === 0 || overlay.img.indexOf('..') === 0)
                ? overlay.img
                : ASSET_PATH + overlay.img;
            img.alt = '';
            img.draggable = false;
            img.style.cssText = 'width:100%;height:100%;object-fit:contain;pointer-events:none';

            el.appendChild(img);
            hero.appendChild(trackEl(el));
        });
    }
    ...
    function apply(data) {
        ...
        // 3. Apply seasonal overlay engine (handles its own homepage checks)
        if (window.GBSeasonalOverlays) {
            window.GBSeasonalOverlays.apply(data.themeId, accent);
        }

        // HOMEPAGE ONLY: decorations (particles, lights, borders, fog) + banner
        if (isHomePage()) {
            // 4. Create decoration container and render
    ...
    function remove() {
        ...
        // Remove seasonal overlays (v2.0 engine)
        if (window.GBSeasonalOverlays) {
            window.GBSeasonalOverlays.cleanup();
        }
