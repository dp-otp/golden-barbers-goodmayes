(function() {
    ...
    var STORAGE_KEY = 'gb_checkout_context_v2';
    ...
    function buildVisitRecord(options) {
        ...
        if (!paymentMethod) {
            ...
            else if (source === 'online_booking' || source === 'qr_walkin') paymentMethod = 'bank_transfer';
        ...
        if (!visitStatus) {
            ...
            else if (source === 'qr_walkin') visitStatus = paymentStatus === 'confirmed' ? 'completed' : 'completed_pending_payment';
        ...
        return {
            ...
            bankReference: sanitizeText(payment.bankReference),
            verifyCode: sanitizeText(payment.verifyCode),
            source: source,
            ...
            requiresManagerVerification: paymentStatus === 'pending_verification',
            verifiedAmount: roundMoney(payment.verifiedAmount),
            targetBank: sanitizeText(payment.targetBank),
            date: visitDate,
            createdAt: createdAt,
    ...
    function getSourceLabel(source) {
        ...
        if (source === 'qr_walkin') return 'In-shop QR';
