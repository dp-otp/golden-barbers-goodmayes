    ...
    function placeGoldenThread(hero, badgeW) {
        try {
            ...
            el.style.cssText = 'position:absolute;left:' + L + 'px;top:' + T + 'px;'
                + 'width:' + W + 'px;height:' + H + 'px;'
                + 'pointer-events:none;z-index:14;opacity:0;transition:opacity 2s ease-out 2.5s;';
            el.innerHTML = svg;
            hero.appendChild(el);
            trackEl(el);
            ...
            ey2.style.cssText = 'position:absolute;'
                ...
                + 'opacity:0;transition:opacity 2s ease-out 2.5s;';
            hero.appendChild(ey2);
            trackEl(ey2);

            // Trigger fade-in (2s ease-out, 2.5s delay — appears after logo is visible)
            el.offsetHeight;
            el.style.opacity = '1';
            ey2.style.opacity = '1';
        } catch (e) {
